...
namespace ChatApp.Server.Infrastructure.Migrations
{
    ...
    [Migration("20250314161626_Correct the friends entity for adding request initiator and receiver")]
    partial class Correctthefriendsentityforaddingrequestinitiatorandreceiver
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.ChatRoomMessage.ChatRoomTextMessageEntity", b =>
                {
                    ...
                    b.ToTable("ChatRoomTextMessages");
                });
