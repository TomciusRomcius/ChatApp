...
namespace ChatApp.Application.Migrations
{
    ...
    [Migration("20250426075117_Cascading on delete with mostly client cascade")]
    partial class Cascadingondeletewithmostlyclientcascade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.PublicUserInfoEntity", b =>
                {
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.PublicUserInfoEntity", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("ChatApp.Domain.Entities.PublicUserInfoEntity", "UserId")
