...
namespace ChatApp.Server.Application.Migrations
{
    ...
    [Migration("20250316120306_rename messages")]
    partial class renamemessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Entities.ChatRoom.ChatRoomEntity", b =>
                {
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Entities.ChatRoom.ChatRoomMemberEntity", b =>
                {
                    b.Property<string>("ChatRoomId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Entities.MessageEntity", b =>
                {
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Entities.TextMessageEntity", b =>
                {
                    b.Property<string>("TextMessageId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Entities.UserFriend.UserFriendEntity", b =>
                {
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Entities.ChatRoom.ChatRoomMemberEntity", b =>
                {
                    b.HasOne("ChatApp.Server.Domain.Entities.ChatRoom.ChatRoomEntity", "ChatRoom")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatApp.Server.Domain.Entities.MessageEntity", b =>
                {
                    ...
                    b.HasOne("ChatApp.Server.Domain.Entities.TextMessageEntity", "TextMessage")
                        .WithMany()
